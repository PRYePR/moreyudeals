...
export interface ApiDealDeal extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Deals and discounts from various sources';
    displayName: 'Deal';
    pluralName: 'deals';
    singularName: 'deal';
  };
  ...
  attributes: {
    ...
    daysRemaining: Schema.Attribute.Integer;
    dealUrl: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    isExpired: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    isTranslated: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::deal.deal'> &
      Schema.Attribute.Private;
    originalDescription: Schema.Attribute.Text;
    ...
    translatedDescription: Schema.Attribute.Text;
    translatedTitle: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 255;
      }>;
    translationProvider: Schema.Attribute.Enumeration<
      ['deepl', 'microsoft', 'google', 'none']
    > &
